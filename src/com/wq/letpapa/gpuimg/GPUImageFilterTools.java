...
public class GPUImageFilterTools {  
  ...
  //      filters.addFilter("Invert", FilterType.INVERT);
       //马赛克 filters.addFilter("Pixelation", FilterType.PIXELATION);
  //      filters.addFilter("Hue", FilterType.HUE);
        filters.addFilter("Gamma", FilterType.GAMMA);// 美白
  //      filters.addFilter("Brightness", FilterType.BRIGHTNESS);
        filters.addFilter("Sepia", FilterType.SEPIA);// 黄昏
        filters.addFilter("Grayscale", FilterType.GRAYSCALE);//黑白
        filters.addFilter("Sharpness", FilterType.SHARPEN);//HDR 瑞华
//        filters.addFilter("Sobel Edge Detection", FilterType.SOBEL_EDGE_DETECTION);//树苗
//        filters.addFilter("3x3 Convolution", FilterType.THREE_X_THREE_CONVOLUTION);//彩色素描
//        filters.addFilter("Emboss", FilterType.EMBOSS);浮雕
...
//        filters.addFilter("Exposure", FilterType.EXPOSURE);
      ...
      //  filters.addFilter("RGB", FilterType.RGB);
        ...
        filters.addFilter("Vignette", FilterType.VIGNETTE);//lomo
        filters.addFilter("ToneCurve", FilterType.TONE_CURVE);//美白 羽化
